...
{
	byte CryptoConstants::UserKey[128] = { //16 * 8
	...
	byte CryptoConstants::bShuffle[256] = { //16 * 16
	...
	byte CryptoConstants::bDefaultAESKeyValue[16] = {
			0xC6, 0x50, 0x53, 0xF2, 0xA8, 0x42, 0x9D, 0x7F, 0x77, 0x09, 0x1D, 0x26, 0x42, 0x53, 0x88, 0x7C,
	};

	byte CryptoConstants::WZ_GMSIV[4] = { 0x4D, 0x23, 0xC7, 0x2B };

	byte CryptoConstants::WZ_MSEAIV[4] = { 0xB9, 0x7D, 0x63, 0xE9 };
